...
function createUseMutation(client, {
  ...
  const useMutation = function useMutation2(mutationFn, opts = {}) {
    ...
    const [state, dispatchReducer] = useReducer(UseMutationReducer, void 0, InitUseMutationReducer);
    const dispatch = useDeferDispatch(dispatchReducer);
    const fnRef = useRef(mutationFn);
    fnRef.current = mutationFn;
    const callRefetchQueries = useCallback(() => {
    ...
    const mutate = useCallback(function mutateFn({
      fn: fnArg,
      args
    } = {}) {
