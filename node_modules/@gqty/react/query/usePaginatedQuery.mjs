...
function createUsePaginatedQuery({
  ...
  function usePaginatedQuery(fn, opts) {
    ...
    const [state, dispatch] = useReducer(UsePaginatedQueryReducer, opts, InitUsePaginatedQueryReducer);
    ...
    const fetchMore = useCallback((newArgs, fetchPolicy = optsRef.current.fetchPolicy || defaultFetchPolicy) => {
