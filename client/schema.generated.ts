...
export const generatedSchema = {
  query: {
    ...
    event: {
      __type: "Event",
      __args: { id: "ID!", idType: "EventIdType", asPreview: "Boolean" },
    },
    eventBy: {
      __type: "Event",
      __args: { id: "ID", eventId: "Int", uri: "String", slug: "String" },
    },
    events: {
 ...
 * The template assigned to the node
 */
export interface Template_Blank extends Omit<ContentTemplate, "__typename"> {
