import { prepass, getFields, getArrayFields, selectFields, castNotSkeleton, castNotSkeletonDeep } from 'gqty';
import { BuildSelectionInput, GQtyError, ResolveOptions, Selection } from 'gqty';
...
export declare function useForceUpdate({ doTimeout }?: {
    ...
    wasCalled: MutableRefObject<boolean>;
};
export declare function useLazyRef<T>(initialValFunc: () => T): MutableRefObject<T>;
export declare const useUpdateEffect: typeof useEffect;
export declare function useIsRendering(): MutableRefObject<boolean>;
export declare function useIsMounted(): MutableRefObject<boolean>;
...
export declare type BuildSelections<T> = (Selection | BuildSelectionInput | T)[];
export declare function useBuildSelections(argSelections: BuildSelections<never> | null | undefined, buildSelection: (...args: BuildSelectionInput) => Selection, getProxySelection: (proxy: ProxyAccessor) => Selection | undefined, caller: Function): {
...
export declare function useInterceptSelections({ interceptorManager: { globalInterceptor, createInterceptor, removeInterceptor, }, staleWhileRevalidate, scheduler, eventHandler, onError, updateOnFetchPromise, }: {
    ...
    fetchingPromise: MutableRefObject<Promise<void> | null>;
    unsubscribe: () => void;
};
